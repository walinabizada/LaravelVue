...
const update = () => {
    form.put(route('dashboard.kbm.update', form.id), {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    ...
    <Head title="Updated Kbm" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Update Kbm "{{ form.service_name }}"</h2>
        </template>
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <form @submit.prevent="update">
                        ...
                        <div class="flex items-center justify-between my-5">
                            <Link class="flex items-center" :href="route('dashboard.kbm.index')"
                                tabindex="-1">
                                <PrimaryButton>
                                Back
                            </PrimaryButton>
