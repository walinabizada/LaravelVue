...
const handleSearch = throttle(() => {
    inertia.get(route('welcome'), pickBy(form.value), { preserveState: false })
}, 150)
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6" :style="'direction: rtl'">
                    <!-- search section -->
                    <div class="mt-4 mb-3">
                                ...
                                <div class="max-w-sm mx-auto">
                                    <label class="relative block">
                                        ...
                                        <input type="text" name="search"
                                            ...
                                            placeholder="Search for anything..." v-model="form.search">
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="">
                        <div id="docs-card"
                            class="my-4 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            v-for="kbm in kbms.data" :key="kbm.id">
                             
                            <div class="grid grid-cols-3 gap-4">
                                <div class="w-full">
                                    <h3>service name</h3>
                                    <p>{{ kbm.service_name }}</p>
                                </div>

                                <div class="w-full col-span-2">
                                    <h3>implementation side</h3>
                                    <p>{{ kbm.implementation_side }}</p>
                                </div>

                            </div>
                            <div class="columns-1 gap-8 w-full">
                                ...
                                <div class="w-full py-2">
                                    <h3>needed document</h3>
                                    <p>{{ kbm.needed_document }}</p>
                                </div>
                                ...
                                <div class="w-full py-2">
                                    ...
                                    <p>{{ kbm.legal_document }}</p>
                                </div>

                                <div class="w-full py-2">
                                    <h3>implementation procedures</h3>
                                    <p>{{ kbm.implementation_procedures }}</p>
                                </div>

                                <div class="w-full py-2">
                                    <h3>course of action</h3>
                                    <p>{{ kbm.course_of_action }}</p>
                                </div>
